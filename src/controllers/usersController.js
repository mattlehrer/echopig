...
function createNewUser(userData, callback) {
  ...
  // create an ID for the private Save for Later feed
...
module.exports = {
        ...
        usersData.findUserByEmail(
          ...
          (err, existingEmailUser) => {
            ...
            createNewUser(newUserData, (err, user) => {
              ...
              req.flash(
                'info',
                `Please verify your account by clicking the link in the email sent to ${user.email}`,
              );
              res.redirect('/');
            });
          },
          ...
          user.save((err, updatedUser) => {
            ...
            mail.sendWithTemplate(
              ...
              (err) => {
                ...
                req.flash(
                  'info',
                  `An e-mail has been sent to ${updatedUser.email} with further instructions.`,
                );
                res.redirect('/login');
              },
            );
  ...
  addSaveByUser(post, user, callback) {
    usersData.addSaveByUser(post, user, callback);
  },
